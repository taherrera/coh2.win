...
"""
	...
	python3 sitemap.py -b doc -b bmp -o sitemap.xml http://www.sltech.cl/index.html
...
class MyHTMLParser(HTMLParser):
    ...
    def __init__(self, pageMap, redirects, baseUrl, maxUrls, blockExtensions, robotParser = None):
